...
def same_shape(t1, t2):
    ...
    """
    "*** YOUR CODE HERE ***"
    return len(branches(t1)) == len(branches(t2)) and \
           all([same_shape(branches(t1)[i], branches(t2)[i]) for i in range(len(branches(t1)))])
...
def add_trees(t1, t2):
    ...
    """
    "*** YOUR CODE HERE ***"
    return tree(label(t1) + label(t2), [add_trees(a, b) for a, b in itertools.zip_longest(branches(t1), branches(t2), fillvalue=tree(0))])
